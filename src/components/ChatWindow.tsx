        ...
        async (payload) => {
          ...
          setMensagens((prev) => {
            ...
            if (novaMensagem.message_sid && prev.some((msg) => (msg as any).message_sid === novaMensagem.message_sid)) {
              console.warn('[ChatWindow] Dedup descartou mensagem duplicada por message_sid:', novaMensagem.message_sid);
              return prev;
            }
            ...
            if (!isMediaMessage) {
              ...
              if (isDuplicateByContent) {
                console.warn('[ChatWindow] Dedup descartou mensagem duplicada por conteúdo+tempo (60s):', { texto: novaMensagem.texto?.slice(0, 50), remetente: novaMensagem.remetente });
                return prev;
              }
            }
